...
static std::vector<std::string> s_Preset_print_options {
    ...
    "active_conical_slicing", "non_planar_angle", "planar_height", "refinement_iterations",
    "use_own_transformation_center", "transformation_center_x", "transformation_center_y",
    "auto_object_fix",
    "inward_cone", "non_planar_max_height"
};
