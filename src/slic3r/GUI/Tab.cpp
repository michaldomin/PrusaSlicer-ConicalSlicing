...
void TabConical::build() {
    ...
    auto page = add_options_page(L("Conical"), "printer");

    auto optgroup = page->new_optgroup(L("Conical"));
...
void TabConical::toggle_options()
{
    ...
    //const bool active_conical = m_config->opt_bool("active_conical_slicing", 0);

    //std::cout<<"aaaaaaaaaaaaaaaaaaaaaaaaa: "<<active_conical<<std::endl;

    //toggle_option("active_conical_slicing", active_conical);
}
